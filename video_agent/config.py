...
class Settings:
    ...
    ollama_model: str = os.getenv("VIDEO_OLLAMA_MODEL", os.getenv("OLLAMA_MODEL", "qwen2.5:7b-instruct"))
    ...
    video_task_budget_seconds: float = float(os.getenv("VIDEO_TASK_BUDGET_SECONDS", os.getenv("MUSIC_TASK_BUDGET_SECONDS", "75")))
